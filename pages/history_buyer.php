...
<html lang="en">
  ...
  <body>
    ...
    <div id="header-layout" class="sticky-top">
      <div id="header" class="row justify-content-between">
        <div class="col-auto">
          ...
          <span id="header-title" class="align-middle">Daftar Pembelian</h4>
        </div>
      </div>
    </div>
    ...
    <script type="text/javascript" src="../assets/js/script-buyer_history.js"></script>
