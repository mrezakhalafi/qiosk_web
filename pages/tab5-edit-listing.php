                                            ...
                                            <div class="image-upload">
                                                <label for="file-input-<?= $i ?>" class="row" style="--bs-gutter-x: none">
                                                    ...
                                                    <?php if (substr($product_image[$i], -3) == "mp4"): ?>
                                                        <video src="../images/<?= str_replace("http://202.158.33.26/qiosk_web/images/", "", $product_image[$i]) ?>#t=0.5" loop autoplay muted id="image-preview-<?= $i ?>" class="upload-listing-border" style="object-fit: none">                                                
                                                    <?php else: ?>
                                                        <img src="../images/<?= str_replace("http://202.158.33.26/qiosk_web/images/", "", $product_image[$i]) ?>" id="image-preview-<?= $i ?>" class="upload-listing-border">
                                                    <?php endif; ?>
