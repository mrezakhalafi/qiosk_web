...
<body class="bg-white-background" style="display:none">
  ...
  <nav class="navbar navbar-light bg-purple">
    <div class="container">
      ...
      <p class="navbar-title" data-translate="tab5security-1">Security</p>
    ...
    <div class="container">
      <div class="row mt-2 mb-2">
          ...
          <div class="col-10 col-md-10 col-lg-10">
              <small data-translate="tab5security-2">Password</small>
          </div>
      </div>
      <a href="">
          <div class="row mt-2 mb-2">
              ...
              <div class="col-10 col-md-10 col-lg-10">
                  <small data-translate="tab5security-3">Login Activity</small>
              </div>
          </div>
      </a>
      <div class="row mt-2 mb-2">
          ...
          <div class="col-10 col-md-10 col-lg-10">
              <small data-translate="tab5security-4">Saved Login Info</small>
          </div>
      </div>
      <div class="row mt-2 mb-2">
          <div class="col-1 col-md-1 col-lg-1">
          ...
          <div class="col-10 col-md-10 col-lg-10">
              <small data-translate="tab5security-5">Two-Factor Authentication</small>
          </div>
      </div>
  </div>
  ...
  <div class="section-menu-2" style="border-top: 1px solid #d1d5db">
    <div class="container">
      <div class="row mt-2 mb-2">
          ...
          <div class="col-10 col-md-10 col-lg-10">
              <small data-translate="tab5security-6">Blocked Account</small>
          </div>
      </div>
    </div>
  </div>
  ...
  <div class="section-menu-2" style="border-top: 1px solid #d1d5db">
    <div class="container">
      <div class="row mt-2 mb-2">
          ...
          <div class="col-10 col-md-10 col-lg-10">
              <small data-translate="tab5security-7">Clear Search History</small>
          </div>
      </div>
    </div>
  </div>
