            ...
            <div class="col-2 col-md-2 col-lg-2">
              ...
              <?php if (substr($product_image[$i], -3) == "mp4"): ?>
                ...
                <?php if ($product_image_video): ?>
                  <img src="../images/<?= str_replace("http://202.158.33.26/qiosk_web/images/", "", $product_image_video) ?>" class="live-featured-image">
                <?php else: ?>
                  <video src="../images/<?= str_replace("http://202.158.33.26/qiosk_web/images/", "", $product_image[0]) ?>#t=0.5" style="object-fit: none" type="video/mp4" class="live-featured-image"></video>
                <?php endif; ?>

              <?php else: ?>

                <img src="../images/<?= str_replace("http://202.158.33.26/qiosk_web/images/", "", $product_image[$i]) ?>" class="live-featured-image">
                  ...
                  <label for="myCheck<?= $product['CODE'] ?>">
                    <div class="form-check form-check-tagged" style="padding-left: 0 !important">
                      ...
                      <?php if(substr($product_image[$i], -3) == "mp4"): ?>
                        ...
                        <?php if ($product_image_video): ?>
                          <img src="../images/<?= str_replace("http://202.158.33.26/qiosk_web/images/", "", $product_image_video) ?>" class="tagged-image">
                        <?php else: ?>
                          <video src="../images/<?= str_replace("http://202.158.33.26/qiosk_web/images/", "", $product_image[0]) ?>#t=0.5" style="object-fit: none" type="video/mp4" class="tagged-image"></video>
                        <?php endif; ?>

                      <?php else: ?>

                        <img src="../images/<?= str_replace("http://202.158.33.26/qiosk_web/images/", "", $product_image[$i]) ?>" class="tagged-image">
