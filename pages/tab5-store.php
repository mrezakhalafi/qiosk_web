        ...
        <div class="col-6">
            ...
            <?php if (substr($product_image[$i], -3) == "mp4"): ?>
              ...
              <?php if ($product_image_video): ?>
                <img src="<?= $product_image_video ?>" class="store-shop">
              <?php else: ?>
                <video src="<?= $product_image[0] ?>" autoplay muted loop style="object-fit: cover; object-position: center; margin-bottom: -10px" type="video/mp4" class="store-shop"></video>
              <?php endif; ?>

            <?php else: ?>

              <img src="<?= $product_image[$i] ?>" class="store-shop">
